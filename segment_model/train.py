...
#cfg = importlib.import_module('./unet-uff-tensorrt-master\model\list_config\config01')
from list_config import config01 as cfg
print('>>>>>>>>>> Prepare to train with file config {} is {}'.format('01', cfg.TRAIN))
#if cfg.TRAIN==False:
#    continue
...
print((cfg.BATCH_SIZE, cfg.image_size, cfg.image_size, 3))
print(train_dataloader[0][1].shape)
print((cfg.BATCH_SIZE, cfg.image_size, cfg.image_size, n_classes))
